...
}else if(!"Control_HIC.hic"%in%BiocFileCache::bfcinfo(bfc)$rname){
    if(.Platform$OS.type == "windows"){
        bfc <- BiocFileCache::bfcadd(
            bfc,"Control_HIC.hic",
            fpath = Hic.url,
...
}else if(!"HeatShock_HIC.mcool"%in%BiocFileCache::bfcinfo(bfc)$rname){
    if(.Platform$OS.type == "windows"){
        bfc <- BiocFileCache::bfcadd(
            bfc,"HeatShock_HIC.mcool",
            fpath = Mcool.url,
