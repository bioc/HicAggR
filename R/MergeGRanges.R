...
#' @param sortRanges <logical>: Whether the result should be sorted. (Default FALSE)
#' @param reduceRanges <logical>: Whether the result should be reduce. See GenomicRanges::reduce for more details. (Default FALSE)
